...
export function StickyActionBar({ stlHref, on3DOpen, onShareOpen }: Props) {
  ...
  return (
    <div className="sticky bottom-0 z-20 flex gap-2 border-t border-border bg-background/95 p-3 backdrop-blur md:static md:border-0 md:bg-transparent md:p-0">
      {stlHref !== null && (
        <Button variant="default" size="sm" className="flex-1" render={<a href={stlHref} />}>
          <Download className="mr-2 size-4" /> {t("catalog.actions.download_stl")}
        </Button>
      )}
