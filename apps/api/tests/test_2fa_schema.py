...
def test_known_entity_types_count_reflects_taxonomy_retirement() -> None:
    ...
    # the legacy taxonomy entity type, bringing it to 15; Story 49.5 adds
    # browse_category for the admin browse-category governance audit, bringing
    # it back to 16. Guard against drift.
    assert len(KNOWN_ENTITY_TYPES) == 16
